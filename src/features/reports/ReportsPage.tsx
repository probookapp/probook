              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-(--color-border)">
                <div className="p-4 bg-(--color-bg-secondary) rounded-lg">
                  ...
                  <p className="text-2xl font-bold">
                    {formatCurrency(
                      revenueData.reduce((sum, r) => sum + r.revenue_ht, 0)
                    )}
                  </p>
                </div>
                <div className="p-4 bg-(--color-bg-secondary) rounded-lg">
                  ...
                  <p className="text-2xl font-bold">
                    {formatCurrency(
                      revenueData.reduce((sum, r) => sum + r.revenue_ttc, 0)
                    )}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            {outstandingData && outstandingData.length > 0 && (
              <div className="p-4 bg-red-50 rounded-lg border border-red-100">
                <p className="text-sm text-red-600">{t("reports:totalUnpaid")}</p>
                <p className="text-2xl font-bold text-red-700">
                  {formatCurrency(
                    outstandingData.reduce((sum, r) => sum + r.total_ttc, 0)
                  )}
                </p>
              </div>
            )}
